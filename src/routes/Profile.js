        ...
        <div className="profileContain">
          <div className="profileInnerBox">
            <div className="profileImg">
              <img src={changeDisplayImg !== '' ? changeDisplayImg : userInfo.photoURL} />
                  ...
                  <div className="imgChangeBtns">
                    {changeDisplayImg !== '' && !isLoading ? (
                      <>
                        ...
                        <button type="button" name="imgChangeCancleBtn" onClick={onClick}>
                          취소
                        </button>
                      </>
                    ) : (
                  ...
                  <form name="nameForm" onSubmit={onSubmit}>
                    ...
                    <div className="nameChangeBtns">
                      {nameEdit && !isLoading ? (
                        <>
                          <button type="submit">저장</button>
                          <button type="button" name="nameChangeCancleBtn" onClick={onClick}>
                            취소
                          </button>
                        </>
                      ) : (
